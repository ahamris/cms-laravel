    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.organization.import-sample') }}" download
                    class="inline-flex items-center gap-2 rounded-md bg-zinc-500 px-4 py-2 text-sm font-semibold text-white shadow-xs hover:bg-zinc-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-600 dark:bg-zinc-600 dark:hover:bg-zinc-500">
