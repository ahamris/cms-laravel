<x-layouts.admin title="Create Vacancy">
<div class="space-y-6">
    {{-- Header --}}
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('title') border-red-500 @enderror" placeholder="Enter job title" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="location" name="location" value="{{ old('location') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('location') border-red-500 @enderror" placeholder="e.g., Amsterdam, Netherlands" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="department" name="department" value="{{ old('department') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('department') border-red-500 @enderror" placeholder="e.g., Engineering, Marketing" required>
                            ...
                            <div>
                                ...
                                <select id="short_code" name="short_code" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('short_code') border-red-500 @enderror" required>
                                    ...
                                    <option value="BE" {{ old('short_code') == 'BE' ? 'selected' : '' }}>BE - Backend</option>
                                    <option value="FE" {{ old('short_code') == 'FE' ? 'selected' : '' }}>FE - Frontend</option>
                                    <option value="MM" {{ old('short_code') == 'MM' ? 'selected' : '' }}>MM - Marketing</option>
                                    <option value="DO" {{ old('short_code') == 'DO' ? 'selected' : '' }}>DO - DevOps</option>
                                    <option value="QA" {{ old('short_code') == 'QA' ? 'selected' : '' }}>QA - Quality Assurance</option>
                                    <option value="AI" {{ old('short_code') == 'AI' ? 'selected' : '' }}>AI - AI/ML</option>
                                    <option value="HR" {{ old('short_code') == 'HR' ? 'selected' : '' }}>HR - Human Resources</option>
                                    <option value="IT" {{ old('short_code') == 'IT' ? 'selected' : '' }}>IT - Information Technology</option>
                                    <option value="PM" {{ old('short_code') == 'PM' ? 'selected' : '' }}>PM - Project Management</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="hours_per_week" name="hours_per_week" value="{{ old('hours_per_week') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('hours_per_week') border-red-500 @enderror" placeholder="e.g., 32 - 40 uur p/w">
                            ...
                            <div>
                                ...
                                <input type="text" id="experience_level" name="experience_level" value="{{ old('experience_level') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('experience_level') border-red-500 @enderror" placeholder="e.g., Geen maximum, 3+ jaar">
                            ...
                            <div>
                                ...
                                <input type="text" id="category" name="category" value="{{ old('category') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('category') border-red-500 @enderror" placeholder="e.g., ICT, Financieel, Communicatie">
                            ...
                            <div>
                                ...
                                <input type="text" id="salary_range" name="salary_range" value="{{ old('salary_range') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('salary_range') border-red-500 @enderror" placeholder="e.g., €50,000 - €70,000" required>
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-editor id="description" name="description" placeholder="Enter job description..." />
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-editor id="requirements" name="requirements" placeholder="Enter job requirements..." />
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-editor id="responsibilities" name="responsibilities" placeholder="Enter job responsibilities..." />
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6 space-y-6">
                            ...
                            {{-- Status --}}
                            <div>
                                <x-ui.toggle name="is_active" label="Status" :checked="old('is_active', '1') == '1'" :required="true" />
