<x-layouts.admin title="Create Case Study">
<div class="space-y-6">
    {{-- Header --}}
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Case Study</h1>
            <p class="text-gray-600">Add a new customer success story</p>
        </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.marketing.case-study.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="challenge"
                                      ...
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary @error('challenge') border-red-500 @enderror">{{ old('challenge') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="solution"
                                      ...
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary @error('solution') border-red-500 @enderror">{{ old('solution') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="results"
                                      ...
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary @error('results') border-red-500 @enderror">{{ old('results') }}</textarea>
                        ...
                        <div id="metrics-container">
                            <div class="metric-item flex items-center space-x-2 mb-2">
                                <input type="text"
                                       name="metrics[]"
                                       value="{{ old('metrics.0') }}"
                                       placeholder="e.g., 300% increase in revenue, 50% reduction in costs"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Client Quote</h3>
                    </div>
                    <div class="p-6 space-y-4">
                        {{-- Quote Text --}}
                        <div>
                            ...
                            <textarea id="quote"
                                      name="quote"
                                      rows="3"
                                      placeholder="Client testimonial or quote about the results..."
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {{-- Quote Author --}}
                            <div>
                                <label for="quote_author" class="block text-sm font-medium text-gray-700 mb-2">Quote Author</label>
                                <input type="text"
                                       id="quote_author"
                                       name="quote_author"
                                       value="{{ old('quote_author') }}"
                                       placeholder="e.g., John Smith"
                                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary @error('quote_author') border-red-500 @enderror">
                                @error('quote_author')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>

                            {{-- Quote Position --}}
                            <div>
                                <label for="quote_position" class="block text-sm font-medium text-gray-700 mb-2">Position/Title</label>
                                <input type="text"
                                       id="quote_position"
                                       name="quote_position"
                                       value="{{ old('quote_position') }}"
                                       placeholder="e.g., CEO, Marketing Director"
                                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary @error('quote_position') border-red-500 @enderror">
                                @error('quote_position')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="tags-container">
                            <div class="tag-item flex items-center space-x-2 mb-2">
                                <input type="text"
                                       name="tags[]"
                                       value="{{ old('tags.0') }}"
                                       placeholder="e.g., Revenue Growth, Process Automation"
                                       class="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary">
