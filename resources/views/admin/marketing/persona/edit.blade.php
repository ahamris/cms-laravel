<x-layouts.admin title="Edit Marketing Persona">
<div class="space-y-6">
    {{-- Header --}}
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Marketing Persona</h1>
            <p class="text-gray-600">Update persona details for {{ $persona->name }}</p>
        </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.marketing.persona.update', $persona) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="description"
                                      ...
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary @error('description') border-red-500 @enderror">{{ old('description', $persona->description) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('demographics.age_range', $persona->demographics['age_range'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('demographics.company_size', $persona->demographics['company_size'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('demographics.industry', $persona->demographics['industry'] ?? '') }}"
                            ...
                            <div>
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('demographics.location', $persona->demographics['location'] ?? '') }}"
                        ...
                        <div class="p-6">
                            <div id="pain-points-container">
                                @if($persona->pain_points && count($persona->pain_points) > 0)
                                    @foreach($persona->pain_points as $index => $painPoint)
                                        <div class="pain-point-item flex items-center space-x-2 mb-2">
                                            <input type="text"
                                                   name="pain_points[]"
                                                   value="{{ old('pain_points.' . $index, $painPoint) }}"
                        ...
                        <div class="p-6">
                            <div id="goals-container">
                                @if($persona->goals && count($persona->goals) > 0)
                                    @foreach($persona->goals as $index => $goal)
                                        <div class="goal-item flex items-center space-x-2 mb-2">
                                            <input type="text"
                                                   name="goals[]"
                                                   value="{{ old('goals.' . $index, $goal) }}"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        @if($persona->avatar_image)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $persona->avatar_image) }}" alt="{{ $persona->name }}" class="w-20 h-20 rounded-full object-cover">
