<x-layouts.admin title="Create Product Feature">
<div class="space-y-6">
    {{-- Header --}}
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Product Feature</h1>
            <p class="text-gray-600">Add a new product feature to the taxonomy</p>
        </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.marketing.product-feature.store') }}" method="POST" class="space-y-6">
        @csrf
                        ...
                        <div id="benefits-container">
                            <div class="benefit-item flex items-center space-x-2 mb-2">
                                <input type="text"
                                       ...
                                       placeholder="e.g., Tijd besparen, Minder fouten"
                        ...
                        <div id="preview" class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-center">
                                <div id="preview-icon" class="h-12 w-12 rounded-lg bg-blue-50 flex items-center justify-center mr-4">
                                    <i id="preview-icon-element" class="fa-solid fa-star text-blue-600 text-xl"></i>
                                </div>
                                <div class="flex-1">
                                    <div class="flex items-center space-x-2 mb-1">
                                        <h4 id="preview-name" class="text-lg font-semibold text-gray-900">Product Feature Name</h4>
                                        <span id="preview-type" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                            <i class="fa-solid fa-check mr-1"></i>Free
                                        </span>
                                    </div>
                                    <p id="preview-category" class="text-sm text-gray-500 mb-2">Category</p>
                                    <p id="preview-description" class="text-sm text-gray-700">Feature description will appear here</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        // Update name
        previewName.textContent = nameInput.value || 'Product Feature Name';
        
        // Update icon
        const iconClass = iconInput.value || 'fa-star';
