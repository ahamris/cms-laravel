<x-layouts.admin title="Create External Code">
<div>
    {{-- Header --}}
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="content"
                                      ...
                                      class="block bg-white w-full border border-gray-200 rounded-md px-3 py-2 font-mono text-sm focus:outline-none @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <x-radio
                                    ...
                                    value="header"
                                    :checked="old('injection_location') == 'header'"
                            ...
                            <div>
                                <x-radio
                                    name="injection_location"
                                    value="body"
                                    :checked="old('injection_location', 'body') == 'body'"
