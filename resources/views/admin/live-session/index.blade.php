<x-layouts.admin title="Live Sessions">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.live-session.create') }}">
        ...
        <livewire:admin.table
            ...
            :columns="[
                ['key' => 'title', 'label' => 'Title', 'type' => 'custom', 'view' => 'admin.live-session.partials.title-column'],
                ['key' => 'session_date', 'label' => 'Date & Time', 'type' => 'custom', 'view' => 'admin.live-session.partials.date-time-column'],
                ['key' => 'duration_minutes', 'label' => 'Duration', 'type' => 'custom', 'view' => 'admin.live-session.partials.duration-column'],
                ['key' => 'presenters.id', 'label' => 'Presenters', 'type' => 'custom', 'view' => 'admin.live-session.partials.presenters-column'],
                ['key' => 'id', 'label' => 'Registrations', 'type' => 'custom', 'view' => 'admin.live-session.partials.registrations-column'],
