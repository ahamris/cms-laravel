<x-layouts.admin title="Changelog Management">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <x-button variant="primary" icon="plus" icon-position="left" href="{{ route('admin.changelog.create') }}">
                Add New Entry
            </x-button>
        </div>
        ...
        <livewire:admin.table
            resource="changelog"
            :columns="[
                ['key' => 'title', 'label' => 'Title', 'type' => 'custom', 'view' => 'admin.changelog.partials.title-column'],
                ['key' => 'status', 'label' => 'Status', 'type' => 'custom', 'view' => 'admin.changelog.partials.status-column'],
