<x-layouts.admin title="Create Social Setting">
    {{-- Page Header --}}
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Create Social Setting</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Add a new social media link to your website</p>
        </div>
    ...
    <form action="{{ route('admin.social-settings.store') }}" method="POST" id="social-setting-form">
        @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div id="namePreview" class="text-sm font-medium text-gray-900 dark:text-white">Social Platform Name</div>
                                    <div id="urlPreview" class="text-xs text-gray-500 dark:text-gray-400">URL will appear here</div>
                                </div>
                            </div>
                        </div>
                    </div>
