                    ...
                    <div>
                        <form action="{{ route('login') }}" method="POST" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm/6">
                                    <a href="{{ route('password.request') }}" class="font-semibold text-[var(--color-accent)] hover:opacity-80 dark:text-[var(--color-accent-content)] dark:hover:opacity-80 transition-opacity">Forgot password?</a>
                                </div>
                            </div>
