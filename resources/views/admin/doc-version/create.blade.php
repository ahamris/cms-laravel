<x-layouts.admin title="Create Documentation Version">
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col gap-1">
                ...
                <p>Add a new doc version (e.g. 1.0, 2.0)</p>
            </div>
        </div>
    ...
    <div class="bg-gray-50/50 rounded-md border border-gray-200">
        <form action="{{ route('admin.doc-versions.store') }}" method="POST" class="space-y-6">
            @csrf
            <div class="p-6 max-w-2xl space-y-6">
                <div>
                    <label for="version" class="block text-xs font-medium text-gray-700 mb-1">Version <span class="text-red-500">*</span></label>
                    <input type="text" id="version" name="version" value="{{ old('version') }}" placeholder="e.g. 1.0 or 2.0"
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Version 1.0"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <x-ui.toggle name="is_default" :checked="old('is_default', false)" label="Default version" />
                </div>
            </div>
            <div class="px-6 py-4 bg-gray-50/80 border-t border-gray-200 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2 text-sm text-white bg-primary rounded-md hover:bg-primary/80">Create Version</button>
            </div>
        </form>
    </div>
</x-layouts.admin>
