        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-white/10">
            <thead class="bg-gray-50 dark:bg-white/5">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Description</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400 max-w-xs truncate">{{ Str::limit($blogType->description, 50) ?: '—' }}</td>
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-6 py-8 text-center text-sm text-gray-500 dark:text-gray-400">No blog types yet. <a href="{{ route('admin.blog-type.create') }}" class="text-[var(--color-accent)] hover:underline">Create one</a>.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
