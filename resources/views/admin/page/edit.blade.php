        ...
        >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    @php
                        $selectedFaqId = old('faq_element_id', $page->elements->firstWhere('type', \App\Enums\ElementType::Faq)?->id);
                        $selectedCtaId = old('cta_element_id', $page->elements->firstWhere('type', \App\Enums\ElementType::Cta)?->id);
                    @endphp
