                ...
                <div class="rounded-md border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 p-6 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <x-ui.select name="course_category_id" label="Category" required
                            ...
                            :value="(string) old('course_category_id', $course->course_category_id)"
                            :error="$errors->has('course_category_id')"
                            :errorMessage="$errors->first('course_category_id')" />

                        <x-ui.input name="name" id="name" label="Name" :value="old('name', $course->name)" required
                        ...
                        <div class="space-y-2">
                            ...
                            <x-ui.textarea name="description" id="description" :value="old('description', $course->description)" :rows="4"
