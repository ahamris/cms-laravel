<x-layouts.admin title="Add Academy Category">
    <form action="{{ route('admin.content.academy-category.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add Academy Category</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Create a new category for academy videos</p>
            </div>
