@if(in_array('edit', $actions))
    <a href="{{ route('admin.content.academy-category.edit', $item) }}">
    ...
    <x-ui.modal modal-id="delete-modal-{{ $item->id }}" alpine-show="showDeleteModal{{ $item->id }}" size="sm">
        ...
        <div class="space-y-4">
            <p class="text-zinc-600 dark:text-zinc-400">
                Are you sure you want to delete this academy category? Videos in this category will need to be reassigned or
                removed.
            </p>
            <div
