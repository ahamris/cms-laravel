    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col gap-1">
                <h2>Edit Documentation Section</h2>
                ...
                <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select id="doc_version_id" 
                            ...
                            @foreach($versions as $version)
                                <option value="{{ $version->id }}" {{ old('doc_version_id', $docSection->doc_version_id) == $version->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="title" 
                               name="title" 
                               value="{{ old('title', $docSection->title) }}" 
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  maxlength="1000">{{ old('description', $docSection->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" 
                                   id="slug" 
                                   name="slug" 
                                   value="{{ old('slug', $docSection->slug) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="sort_order" 
                                   name="sort_order" 
                                   value="{{ old('sort_order', $docSection->sort_order) }}" 
                        ...
                        <div class="flex items-end">
                            <div class="flex items-center h-10">
                                <input type="checkbox" 
                                       ...
                                       {{ old('is_active', $docSection->is_active) ? 'checked' : '' }}>
