...
<style>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-3xl font-bold text-gray-900">Edit Form</h2>
                <p class="text-gray-600 mt-2">Update your form settings and fields</p>
            </div>
    ...
    <form action="{{ route('admin.content.form-builder.update', $formBuilder) }}" method="POST" id="formBuilderForm">
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="identifier" 
                                   id="identifier"
                                   value="{{ old('identifier', $formBuilder->identifier) }}"
                                   readonly
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 @error('identifier') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Brief description of this form">{{ old('description', $formBuilder->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="success_message" 
                                      ...
                                      placeholder="Thank you for your submission!">{{ old('success_message', $formBuilder->success_message) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="url" 
                                   name="redirect_url" 
                                   id="redirect_url"
                                   value="{{ old('redirect_url', $formBuilder->redirect_url) }}"
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('submit_button_text', $formBuilder->submit_button_text) }}"
                                   class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200"
                                   placeholder="Submit">
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <x-ui.toggle
                            ...
                            :checked="old('send_email_notification', $formBuilder->send_email_notification)"
                        ...
                        <div>
                            ...
                            <textarea name="notification_emails" 
                                      ...
                                      rows="3"
                                      class="block w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200"
                                      placeholder="admin@example.com, sales@example.com">{{ old('notification_emails', $formBuilder->notification_emails) }}</textarea>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <x-ui.toggle
                                   name="is_api_form" 
                                   id="is_api_form"
                            :checked="old('is_api_form', $formBuilder->is_api_form)"
                                   onchange="toggleApiFields()"
                        />
                    </div>
                    
                    <div id="apiFormFields" class="mt-3 space-y-3 transition-all duration-200" style="display: {{ old('is_api_form', $formBuilder->is_api_form) ? 'block' : 'none' }}; max-height: {{ old('is_api_form', $formBuilder->is_api_form) ? '500px' : '0' }}; overflow: hidden;">
                        <div>
                            ...
                            <input type="url" 
                                   name="api_url" 
                                   id="api_url"
                                   value="{{ old('api_url', $formBuilder->api_url) }}"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="api_token" 
                                   id="api_token"
                                   value="{{ old('api_token', $formBuilder->api_token) }}"
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <x-ui.toggle
                               name="is_active" 
                               id="is_active"
                        :checked="old('is_active', $formBuilder->is_active)"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const existingFields = @json($formBuilder->fields ?? []);
        
        if (existingFields && existingFields.length > 0) {
            // Set fieldCounter to the highest ID
            fieldCounter = Math.max(...existingFields.map(f => f.id || 0), 0);
            
            // Load existing fields
            fields = existingFields.map(field => ({
                id: field.id || ++fieldCounter,
    ...
    function updateField(id, property, value) {
        ...
        if (field) {
            ...
            // Update hidden input without re-rendering
                ...
                <div class="field-item bg-gray-50 border border-gray-200 rounded-xl p-4" data-field-id="${field.id}">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <textarea 
                                onchange="updateFieldOptions(${field.id}, this.value)"
                                class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                                rows="3"
