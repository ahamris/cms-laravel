<x-layouts.admin title="Edit Solution">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('admin.content.solution.show', $solution) }}" class="inline-flex items-center gap-2 rounded-md bg-white dark:bg-white/10 px-4 py-2 text-sm font-semibold text-gray-900 dark:text-white shadow-xs ring-1 ring-gray-300 ring-inset dark:ring-white/10 hover:bg-gray-50 dark:hover:bg-white/20">
    ...
    <form action="{{ route('admin.content.solution.update', $solution) }}" method="POST" enctype="multipart/form-data" id="solution-form">
        @csrf
        @method('PUT')
        ...
        <div class="mt-8 flex flex-col sm:flex-row items-center justify-end gap-4 border-t border-gray-200 dark:border-white/10 pt-6">
            <a href="{{ route('admin.content.solution.index') }}" class="text-sm/6 font-semibold text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300">Cancel</a>
