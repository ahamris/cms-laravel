<x-layouts.admin title="Create Solution">
    ...
    <form action="{{ route('admin.content.solution.store') }}" method="POST" enctype="multipart/form-data" id="solution-form">
        @csrf
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <x-ui.toggle 
                                    ...
                                    :checked="old('show_modules_header', false)"
                                />
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <x-ui.toggle 
                                    ...
                                    :checked="old('show_news_articles', false)"
                                />
                            </div>
                        </div>
                    </div>
