<x-layouts.admin title="Create Hero Media Widget">
<div class="space-y-6">
    {{-- Header --}}
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Hero Media Widget</h1>
            <p class="text-gray-600">Create a new hero section with image/video background</p>
        </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.content.hero-widget.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('top_header_text_color', '#ffffff') }}"
                            ...
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('top_header_bg_color', '#ffffff1a') }}"
                                       class="w-full h-10 border border-gray-300 rounded-lg">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="subtitle"
                                      ...
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary">{{ old('subtitle') }}</textarea>
                        </div>
                        <div>
                            ...
                            <input type="color"
                                   id="subtitle_color"
                                   name="subtitle_color"
                                   value="{{ old('subtitle_color', '#d1d5db') }}"
                                   class="w-full h-10 border border-gray-300 rounded-lg">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <div id="no-items-state" class="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg {{ (old('list_items') && count(old('list_items', [])) > 0) ? 'hidden' : '' }}">
                        ...
                        <div id="list-items-form" class="{{ (old('list_items') && count(old('list_items', [])) > 0) ? '' : 'hidden' }}">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <input type="color"
                                           ...
                                           value="{{ old('list_item_color', '#3b82f6') }}"
                                           class="w-full h-10 border border-gray-300 rounded-lg">
                                </div>
                            </div>
                            <div id="list-items-container" class="space-y-2">
                                @if(old('list_items') && count(old('list_items', [])) > 0)
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div x-data="heroWidgetUrlSelector(@js(old('primary_button_url') ?? ''), @js(old('primary_button_url') ? 'custom' : 'custom'), @js($availableRoutes ?? []), @js($systemContent ?? []), 'primary_button')" class="space-y-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('primary_button_text_color', '#ffffff') }}"
                                       class="w-full h-10 border border-gray-300 rounded-lg">
                            </div>
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('primary_button_bg_color', '#3b82f6') }}"
                                       class="w-full h-10 border border-gray-300 rounded-lg">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <x-icon-picker
                                    ...
                                    :value="old('secondary_button_icon')"
                                    label="Button Icon"
                                    help-text=""
                                    :required="false"
                                />
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Button URL</label>
                            <div x-data="heroWidgetUrlSelector(@js(old('secondary_button_url') ?? ''), @js(old('secondary_button_url') ? 'custom' : 'custom'), @js($availableRoutes ?? []), @js($systemContent ?? []), 'secondary_button')" class="space-y-2">
                                <div class="grid grid-cols-3 gap-2 mb-3">
                                    <label class="flex items-center space-x-1 cursor-pointer text-xs">
                                        <input type="radio" x-model="linkType" value="predefined" @change="updateUrl()" class="w-3 h-3 text-primary border-gray-300 focus:ring-primary">
                                        <span class="text-gray-700">Predefined</span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('secondary_button_text_color', '#ffffff') }}"
                                       class="w-full h-10 border border-gray-300 rounded-lg">
                            </div>
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('secondary_button_bg_color', 'transparent') }}"
                                       class="w-full h-10 border border-gray-300 rounded-lg">
                            </div>
                            <div>
                                ...
                                <input type="color"
                                       ...
                                       value="{{ old('secondary_button_border_color', '#ffffff') }}"
                                       class="w-full h-10 border border-gray-300 rounded-lg">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="flex items-center space-x-2 cursor-pointer p-4 border-2 rounded-lg {{ old('background_type', 'image') === 'image' ? 'border-primary bg-primary/5' : 'border-gray-200' }}">
                                    <input type="radio" name="background_type" value="image" {{ old('background_type', 'image') === 'image' ? 'checked' : '' }} class="text-primary focus:ring-primary">
                                    <span class="text-sm font-medium">Image</span>
                                </label>
                                <label class="flex items-center space-x-2 cursor-pointer p-4 border-2 rounded-lg {{ old('background_type', 'image') === 'video' ? 'border-primary bg-primary/5' : 'border-gray-200' }}">
                                    <input type="radio" name="background_type" value="video" {{ old('background_type', 'image') === 'video' ? 'checked' : '' }} class="text-primary focus:ring-primary">
                                    <span class="text-sm font-medium">Video</span>
                                </label>
                            </div>
                        </div>

                        <div id="image-section" class="{{ old('background_type', 'image') === 'image' ? '' : 'hidden' }}">
                            <x-image-upload
                                id="image"
                                name="image"
                        ...
                        <div id="video-section" class="{{ old('background_type', 'image') === 'video' ? '' : 'hidden' }}">
    ...
    let listItemIndex = {{ count(old('list_items', [])) }};
