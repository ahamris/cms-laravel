<x-layouts.admin title="Blog Categories">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.content.blog-category.create') }}"
        ...
        ['key' => 'created_at', 'format' => 'date'],
            ...
            custom-actions-view="admin.content.blog-category.partials.table-actions"
        ...
        <x-ui.drawer drawer-id="blog-category-drawer" max-width="2xl">
            <form id="blog-category-form" method="POST" action="{{ route('admin.content.blog-category.store') }}"
                class="relative flex h-full flex-col overflow-y-auto bg-white shadow-xl dark:bg-gray-800 dark:after:absolute dark:after:inset-y-0 dark:after:left-0 dark:after:w-px dark:after:bg-white/10">
                @csrf
    ...
    <script>
        ...
        function openEditDrawer(id) {
            ...
            form.action = '{{ route('admin.content.blog-category.update', ':id') }}'.replace(':id', id);
            ...
            // Veriyi yükle
            window.axios.get(`{{ route('admin.content.blog-category.json', ':id') }}`.replace(':id', id))
                .then(response => {
