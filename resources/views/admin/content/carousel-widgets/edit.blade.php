<x-layouts.admin title="Edit Carousel Widget">
<div class="space-y-6">
    {{-- Header --}}
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Carousel Widget</h1>
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text"
                                   id="name"
                                   name="name"
                                   value="{{ old('name', $carouselWidget->name) }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   id="identifier"
                                   name="identifier"
                                   value="{{ old('identifier', $carouselWidget->identifier) }}"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   id="title"
                                   name="title"
                                   value="{{ old('title', $carouselWidget->title) }}"
                        ...
                        <div>
                            ...
                            <textarea id="description"
                                      ...
                                      rows="3"
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary"
                                      placeholder="Display latest blog articles">{{ old('description', $carouselWidget->description) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <select id="data_source"
                                ...
                                <option value="blog" {{ old('data_source', $carouselWidget->data_source) === 'blog' ? 'selected' : '' }}>Blog Articles</option>
                                <option value="custom" {{ old('data_source', $carouselWidget->data_source) === 'custom' ? 'selected' : '' }}>Custom Content</option>
                            </select>
                        </div>

                        <div id="blogCategoryField" style="display: {{ old('data_source', $carouselWidget->data_source) === 'blog' ? 'block' : 'none' }};">
                            ...
                            <select id="blog_category_id"
                                ...
                                @foreach($blogCategories as $category)
                                    <option value="{{ $category->id }}" {{ old('blog_category_id', $carouselWidget->blog_category_id) == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number"
                                       id="items_per_row"
                                       name="items_per_row"
                                       value="{{ old('items_per_row', $carouselWidget->items_per_row) }}"
                                       min="1"
                                       max="12"
                            ...
                            <div>
                                ...
                                <input type="number"
                                       id="total_items"
                                       name="total_items"
                                       value="{{ old('total_items', $carouselWidget->total_items) }}"
                                       min="1"
                                       max="50"
                                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary"
                                       required>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <x-ui.toggle
                            name="show_arrows"
                            :checked="old('show_arrows', $carouselWidget->show_arrows)"
                        ...
                        <x-ui.toggle
                            name="show_dots"
                            :checked="old('show_dots', $carouselWidget->show_dots)"
                        ...
                        <x-ui.toggle
                            name="show_author"
                            :checked="old('show_author', $carouselWidget->show_author ?? true)"
                            label="Show Author"
                        ...
                        <x-ui.toggle
                            name="autoplay"
                            id="autoplay"
                            :checked="old('autoplay', $carouselWidget->autoplay)"
                            label="Autoplay"
                            description="Automatically advance slides"
                            onchange="toggleAutoplaySpeed()"
                        />

                        <div id="autoplaySpeedField" style="display: {{ old('autoplay', $carouselWidget->autoplay) ? 'block' : 'none' }};">
                            ...
                            <input type="number"
                                   id="autoplay_speed"
                                   name="autoplay_speed"
                                   value="{{ old('autoplay_speed', $carouselWidget->autoplay_speed) }}"
                                   min="1000"
                                   max="10000"
                                   step="500"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary">
                        ...
                        <x-ui.toggle
                            name="infinite_loop"
                            :checked="old('infinite_loop', $carouselWidget->infinite_loop)"
                            label="Infinite Loop"
                        ...
                        <x-ui.toggle
                            ...
                            :checked="old('show_view_all_button', $carouselWidget->show_view_all_button ?? false)"
                            label="Show View All Button"
                            description="Display a 'View All' card as the last item in the carousel"
                            onchange="toggleViewAllFields()"
                        />

                        <div id="viewAllFields" style="display: {{ old('show_view_all_button', $carouselWidget->show_view_all_button ?? false) ? 'block' : 'none' }};">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text"
                                           id="view_all_title"
                                           name="view_all_title"
                                           value="{{ old('view_all_title', $carouselWidget->view_all_title ?? 'View All Articles') }}"
                                ...
                                <div>
                                    ...
                                    <textarea id="view_all_description"
                                              ...
                                              rows="2"
                                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary"
                                              placeholder="Discover all our blog articles">{{ old('view_all_description', $carouselWidget->view_all_description) }}</textarea>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="number"
                                   id="sort_order"
                                   name="sort_order"
                                   value="{{ old('sort_order', $carouselWidget->sort_order ?? 0) }}"
                                   min="0"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary">
                        ...
                        <div>
                            <x-ui.toggle
                                name="is_active"
                                :checked="old('is_active', $carouselWidget->is_active)"
