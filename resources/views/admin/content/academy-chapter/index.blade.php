    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.content.academy-chapter.create') }}">
        ...
        {{-- Table --}}
        <livewire:admin.table resource="academy-chapter" :columns="[
            'id',
        ...
        ]" route-prefix="admin.content.academy-chapter"
            search-placeholder="Search chapters..." :paginate="15"
            custom-actions-view="admin.content.academy-chapter.partials.table-actions"
