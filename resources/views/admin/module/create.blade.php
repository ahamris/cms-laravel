<x-layouts.admin title="Create Module">
    {{-- Page Header --}}
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Create Module</h1>
                    ...
                    <div>
                        ...
                        <select id="feature_id" name="feature_id" class="w-full rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-white/5 px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-accent)]">
                            ...
                            @foreach($features as $feat)
                                <option value="{{ $feat->id }}" {{ old('feature_id') == $feat->id ? 'selected' : '' }}>{{ $feat->title }}</option>
                            @endforeach
                        </select>
                        ...
                        <div>
                            ...
                            <div class="flex gap-4">
                                <x-ui.radio
                                    name="image_position"
                                    value="left"
                                    :checked="old('image_position', 'right') === 'left'"
                                    label="Left"
                                    color="primary"
                                />
                                <x-ui.radio
                                    name="image_position"
                                    value="right"
                                    :checked="old('image_position', 'right') === 'right'"
                                    label="Right"
                                    color="primary"
                                />
                            </div>
