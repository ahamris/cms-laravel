    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <x-button variant="primary" icon="plus" icon-position="left" href="{{ route('admin.module.create') }}">Create New Module</x-button>
            </div>
        </div>
        ...
        <livewire:admin.table
            ...
            :columns="[
                ...
                ['key' => 'anchor', 'label' => 'Anchor / Nav Title', 'type' => 'custom', 'view' => 'admin.module.partials.anchor-column'],
                ['key' => 'title', 'limit' => 50],
