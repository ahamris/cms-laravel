<x-layouts.admin title="Edit Module">
    {{-- Page Header --}}
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Edit Module</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Update the module information</p>
        </div>
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('admin.content.module.show', $module) }}" class="inline-flex items-center gap-2 rounded-md bg-white dark:bg-white/10 px-4 py-2 text-sm font-semibold text-gray-900 dark:text-white shadow-xs ring-1 ring-gray-300 ring-inset dark:ring-white/10 hover:bg-gray-50 dark:hover:bg-white/20">
    ...
    <form action="{{ route('admin.content.module.update', $module) }}" method="POST" enctype="multipart/form-data" id="module-form">
        @csrf
        @method('PUT')
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Basic information about your module including anchor, title, and content.</p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-ui.input
                                    id="anchor"
                                    name="anchor"
                                    :value="old('anchor', $module->anchor)"
                                    label="Anchor ID"
                            ...
                            <div>
                                <x-ui.input
                                    id="nav_title"
                                    name="nav_title"
                                    :value="old('nav_title', $module->nav_title)"
                        ...
                        <div>
                            <x-ui.input
                                id="link_text"
                                name="link_text"
                                :value="old('link_text', $module->link_text)"
                                label="Link Text"
                        ...
                        <div>
                            <x-ui.textarea
                                id="subtitle"
                                name="subtitle"
                                :value="old('subtitle', $module->subtitle)"
                                label="Subtitle"
                        ...
                        <div>
                            <x-ui.textarea
                                id="short_body"
                                name="short_body"
                                :value="old('short_body', $module->short_body)"
                                label="Short Body"
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <x-editor 
                                    id="long_body" 
                                    name="long_body" 
                                    :value="old('long_body', $module->long_body)"
                        ...
                        {{-- List Items --}}
                        <div>
                            <label class="block text-sm/6 font-medium text-gray-900 dark:text-white mb-2">List Items</label>
                            <div id="list-items-container" class="space-y-2">
                                @if($module->list_items && count($module->list_items) > 0)
                                    @foreach($module->list_items as $index => $item)
                ...
                <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Optional customer testimonial for this module.</p>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            <x-ui.textarea
                                ...
                                :value="old('testimonial_quote', $module->testimonial_quote)"
                                label="Quote"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-ui.input
                                    ...
                                    :value="old('testimonial_author', $module->testimonial_author)"
                                    label="Author Name"
                            ...
                            <div>
                                <x-ui.input
                                    ...
                                    :value="old('testimonial_company', $module->testimonial_company)"
                                    label="Company"
                ...
                <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                    ...
                    <div class="space-y-6">
                        @php
                            $metaKeywordsTags = array_values(array_filter(array_map('trim', explode(',', (string) old('meta_keywords', $module->meta_keywords ?? '')))));
                        @endphp
                        ...
                        <div>
                            <x-ui.textarea
                                ...
                                :value="old('meta_description', $module->meta_description)"
            ...
            <div class="lg:col-span-1 space-y-8">
                ...
                <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Upload a featured image for your module.</p>
                    </div>
                    ...
                    <x-image-upload 
                        ...
                        :max-size="2048"
                        :current-image="$module->image ? Storage::url($module->image) : null"
                        current-image-alt="Module image"
                    />
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex gap-4">
                                <x-ui.radio
                                    name="image_position"
                                    value="left"
                                    :checked="old('image_position', $module->image_position) === 'left'"
                                    label="Left"
                                    color="primary"
                                />
                                <x-ui.radio
                                    name="image_position"
                                    value="right"
                                    :checked="old('image_position', $module->image_position) === 'right'"
                                    label="Right"
                                    color="primary"
                                />
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm/6 text-gray-600 dark:text-gray-400">Make module visible</p>
                            </div>
                            <div>
                                <input type="hidden" name="is_active" value="0">
                                <x-ui.toggle 
                                    name="is_active"
                                    :checked="old('is_active', $module->is_active)"
                                />
                            </div>
                        </div>
                    </div>
    ...
    <script>
    @php
        $existingItems = $module->list_items ?? [];
