<x-layouts.admin title="Edit Module">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('admin.module.show', $module) }}" class="inline-flex items-center gap-2 rounded-md bg-white dark:bg-white/10 px-4 py-2 text-sm font-semibold text-gray-900 dark:text-white shadow-xs ring-1 ring-gray-300 ring-inset dark:ring-white/10 hover:bg-gray-50 dark:hover:bg-white/20">
    ...
    <form action="{{ route('admin.module.update', $module) }}" method="POST" enctype="multipart/form-data" id="module-form">
        @csrf
        @method('PUT')
