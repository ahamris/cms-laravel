<x-layouts.admin title="Edit FAQ Group">
<div class="space-y-6">
    {{-- Header --}}
    ...
    {{-- Form --}}
    <form action="{{ route('admin.content.faq-module.update', ['faq' => $faq]) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="identifier" 
                                   name="identifier" 
                                   value="{{ old('identifier', $faq->identifier) }}" 
