    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <x-ui.button variant="primary" icon="plus" icon-position="left" href="{{ route('admin.sticky-menu-item.create') }}">
                    New Item
                </x-ui.button>
            </div>
        </div>
        ...
        <livewire:admin.table
            ...
            :columns="[
                ['key' => 'title', 'label' => 'Item', 'type' => 'custom', 'view' => 'admin.sticky-menu-item.partials.title-column'],
                ['key' => 'link', 'label' => 'Link', 'type' => 'custom', 'view' => 'admin.sticky-menu-item.partials.link-column'],
                ['key' => 'link_type', 'label' => 'Type', 'type' => 'custom', 'view' => 'admin.sticky-menu-item.partials.type-column'],
