...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.content.event.index') }}" 
    ...
    <div class="bg-gray-50/50 rounded-md border border-gray-200">
        <form action="{{ route('admin.content.event.store') }}" method="POST" enctype="multipart/form-data" id="eventForm">
            @csrf
            <div class="p-6">
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="title" name="title" value="{{ old('title') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('title') border-red-500 @enderror" placeholder="Enter event title" required>
                                ...
                                <div>
                                    ...
                                    <textarea id="short_body" name="short_body" rows="3" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('short_body') border-red-500 @enderror" placeholder="Brief description of the event" required>{{ old('short_body') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <x-editor id="long_body" name="long_body" placeholder="Write the full content of the event here..." />
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="2" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('description') border-red-500 @enderror" placeholder="Additional event information..." maxlength="500">{{ old('description') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="location" name="location" value="{{ old('location') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('location') border-red-500 @enderror" placeholder="Event location" required>
                                ...
                                <div>
                                    ...
                                    <textarea id="address" name="address" rows="2" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('address') border-red-500 @enderror" placeholder="Full address of the event location" maxlength="500">{{ old('address') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="price" name="price" value="{{ old('price') }}" step="0.01" min="0" class="w-full pl-8 pr-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('price') border-red-500 @enderror" placeholder="0.00">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="url" id="registration_url" name="registration_url" value="{{ old('registration_url') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('registration_url') border-red-500 @enderror" placeholder="https://example.com/register">
                                    @error('registration_url')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                                </div>

                                {{-- Status --}}
                                <div>
                                    <x-ui.toggle name="is_active" label="Status" :checked="old('is_active') == '1'" :required="true" />
                        ...
                        <div class="bg-gray-50/50 rounded-md border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="time" id="start_time" name="start_time" value="{{ old('start_time') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('start_time') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="time" id="end_time" name="end_time" value="{{ old('end_time') }}" class="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-md focus:outline-none @error('end_time') border-red-500 @enderror">
