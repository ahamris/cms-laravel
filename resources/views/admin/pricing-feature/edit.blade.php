<x-layouts.admin title="Edit Pricing Feature">
<div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" id="category" name="category" value="{{ old('category', $pricingFeature->category) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $pricingFeature->name) }}" required
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary">{{ old('description', $pricingFeature->description) }}</textarea>
                        </div>

                        <div>
                            <label for="badge" class="block text-sm font-medium text-gray-700 mb-1">Badge</label>
                            <input type="text" id="badge" name="badge" value="{{ old('badge', $pricingFeature->badge) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $pricingFeature->sort_order) }}" min="0"
                                   class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        <x-ui.toggle 
                            name="is_active"
                            :checked="old('is_active', $pricingFeature->is_active)"
                            label="Active"
                        />
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
                    <button type="submit" class="w-full bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/80 transition-colors duration-200">
                        <i class="fa-solid fa-save mr-2"></i>Update Feature
                    </button>
                </div>
            </div>
        </div>
