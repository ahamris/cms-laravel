<x-layouts.admin title="Create New User">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.administrator.users.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Enter the user's basic information.</p>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="secondary_email" id="secondary_email" value="{{ old('secondary_email') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize permissions based on current roles (if any are pre-selected)
