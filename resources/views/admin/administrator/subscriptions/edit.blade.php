<x-layouts.admin title="Edit Subscription">
    {{-- Page Header --}}
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Edit Subscription</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Update subscription #{{ $subscription->id }} - {{ $subscription->full_name }}</p>
        </div>
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('admin.administrator.subscriptions.show', $subscription) }}" class="inline-flex items-center gap-2 rounded-md bg-white dark:bg-white/10 px-4 py-2 text-sm font-semibold text-gray-900 dark:text-white shadow-xs ring-1 ring-gray-300 ring-inset dark:ring-white/10 hover:bg-gray-50 dark:hover:bg-white/20">
    ...
    <form action="{{ route('admin.administrator.subscriptions.update', $subscription) }}" method="POST" id="subscriptionForm">
        @method('PUT')
        @csrf
                ...
                <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <x-ui.input
                            id="job_title"
                            name="job_title"
                            :value="old('job_title', $subscription->job_title ?? '')"
                            label="Job Title"
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <x-ui.input
                                id="company_name"
                                name="company_name"
                                :value="old('company_name', $subscription->company_name)"
                                label="Company Name"
                            ...
                            {{-- Company Size --}}
                            <div>
                                <label for="company_size" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Company Size</label>
                                <div class="mt-2 grid grid-cols-1">
                                    <select id="company_size" 
                                        ...
                                        <option value="small" {{ old('company_size', $subscription->company_size) === 'small' ? 'selected' : '' }}>Small (1-50 employees)</option>
                                        <option value="medium" {{ old('company_size', $subscription->company_size) === 'medium' ? 'selected' : '' }}>Medium (51-250 employees)</option>
                                        <option value="large" {{ old('company_size', $subscription->company_size) === 'large' ? 'selected' : '' }}>Large (251-1000 employees)</option>
                                        <option value="enterprise" {{ old('company_size', $subscription->company_size) === 'enterprise' ? 'selected' : '' }}>Enterprise (1000+ employees)</option>
                                    </select>
                                ...
                                @error('company_size')<p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <x-ui.input
                                id="industry"
                                name="industry"
                                :value="old('industry', $subscription->industry)"
                                label="Industry"
                            ...
                            <x-ui.input
                                ...
                                id="website"
                                name="website"
                                :value="old('website', $subscription->website)"
                                label="Website"
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <x-ui.input
                                ...
                                :value="old('product_interest', $subscription->product_interest ?? '')"
                            ...
                            <div>
                                <label for="preferred_contact_method" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Preferred Contact Method</label>
                                <div class="mt-2 grid grid-cols-1">
                                    <select id="preferred_contact_method" 
                                        ...
                                        <option value="email" {{ old('preferred_contact_method', $subscription->preferred_contact_method ?? 'email') === 'email' ? 'selected' : '' }}>Email</option>
                                        <option value="phone" {{ old('preferred_contact_method', $subscription->preferred_contact_method) === 'phone' ? 'selected' : '' }}>Phone</option>
                                        <option value="both" {{ old('preferred_contact_method', $subscription->preferred_contact_method) === 'both' ? 'selected' : '' }}>Both</option>
                                    </select>
                                    <svg viewBox="0 0 16 16" fill="currentColor" class="pointer-events-none col-start-1 row-start-1 mr-2 size-5 self-center justify-self-end text-gray-500 sm:size-4 dark:text-gray-400">
                                        <path d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                </div>
                                @error('preferred_contact_method')<p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <x-ui.input
                                ...
                                :value="old('preferred_demo_date', $subscription->preferred_demo_date?->format('Y-m-d'))"
                            ...
                            {{-- Preferred Demo Time --}}
                            <div>
                                <label for="preferred_demo_time" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Preferred Demo Time</label>
                                <div class="mt-2 grid grid-cols-1">
                                    <select id="preferred_demo_time" 
                                        ...
                                        <option value="morning" {{ old('preferred_demo_time', $subscription->preferred_demo_time) === 'morning' ? 'selected' : '' }}>Morning (9:00 - 12:00)</option>
                                        <option value="afternoon" {{ old('preferred_demo_time', $subscription->preferred_demo_time) === 'afternoon' ? 'selected' : '' }}>Afternoon (12:00 - 17:00)</option>
                                        <option value="evening" {{ old('preferred_demo_time', $subscription->preferred_demo_time) === 'evening' ? 'selected' : '' }}>Evening (17:00 - 20:00)</option>
                                    </select>
                                    <svg viewBox="0 0 16 16" fill="currentColor" class="pointer-events-none col-start-1 row-start-1 mr-2 size-5 self-center justify-self-end text-gray-500 sm:size-4 dark:text-gray-400">
                                        <path d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" fill-rule="evenodd" />
                                    </svg>
                                </div>
                                @error('preferred_demo_time')<p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <x-ui.textarea
                                id="message"
                                name="message"
                                :value="old('message', $subscription->message)"
                                rows="4"
                ...
                <div class="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2 grid grid-cols-1">
                                <select id="status" 
                                    ...
                                    <option value="new" {{ old('status', $subscription->status) === 'new' ? 'selected' : '' }}>New Subscription</option>
                                    <option value="contacted" {{ old('status', $subscription->status) === 'contacted' ? 'selected' : '' }}>Contacted</option>
                                    <option value="demo_scheduled" {{ old('status', $subscription->status) === 'demo_scheduled' ? 'selected' : '' }}>Demo Scheduled</option>
                                    <option value="demo_completed" {{ old('status', $subscription->status) === 'demo_completed' ? 'selected' : '' }}>Demo Completed</option>
                                    <option value="converted" {{ old('status', $subscription->status) === 'converted' ? 'selected' : '' }}>Converted to Customer</option>
                                    <option value="rejected" {{ old('status', $subscription->status) === 'rejected' ? 'selected' : '' }}>Rejected</option>
                                </select>
                                <svg viewBox="0 0 16 16" fill="currentColor" class="pointer-events-none col-start-1 row-start-1 mr-2 size-5 self-center justify-self-end text-gray-500 sm:size-4 dark:text-gray-400">
                                    <path d="M4.22 6.22a.75.75 0 0 1 1.06 0L8 8.94l2.72-2.72a.75.75 0 1 1 1.06 1.06l-3.25 3.25a.75.75 0 0 1-1.06 0L4.22 7.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" fill-rule="evenodd" />
                                </svg>
                        ...
                        <x-ui.input
                            id="source"
                            name="source"
                            :value="old('source', $subscription->source ?? 'website')"
                            label="Source"
                        ...
                        <div>
                            ...
                            <x-ui.textarea
                                id="admin_notes"
                                name="admin_notes"
                                :value="old('admin_notes', $subscription->admin_notes)"
                                rows="3"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <x-ui.toggle 
                                    name="is_active"
                                    :checked="old('is_active', $subscription->is_active)"
                                />
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <label class="block text-sm/6 font-medium text-gray-900 dark:text-white">Newsletter Consent</label>
                                <p class="text-sm/6 text-gray-600 dark:text-gray-400">Subscriber consented to newsletter</p>
                            </div>
                            <div>
                                <input type="hidden" name="newsletter_consent" value="0">
                                <x-ui.toggle 
                                    name="newsletter_consent"
                                    :checked="old('newsletter_consent', $subscription->newsletter_consent ?? false)"
                                />
                            </div>
                        </div>
                        @error('newsletter_consent')<p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror

                        {{-- Marketing Consent Toggle --}}
                        <div class="flex items-center justify-between">
                            <div>
                                <label class="block text-sm/6 font-medium text-gray-900 dark:text-white">Marketing Consent</label>
                                <p class="text-sm/6 text-gray-600 dark:text-gray-400">Subscriber consented to marketing</p>
                            </div>
                            <div>
                                <input type="hidden" name="marketing_consent" value="0">
                                <x-ui.toggle 
                                    name="marketing_consent"
                                    :checked="old('marketing_consent', $subscription->marketing_consent ?? false)"
                                />
                            </div>
                        </div>
                        @error('marketing_consent')<p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>@enderror
                    </div>
                </div>
            </div>
        </div>
