<x-layouts.admin title="Add Footer Link">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Add Footer Link</h1>
            <p class="text-zinc-600 dark:text-zinc-400">Add a new link to the site footer. Choose a column and link type.</p>
        </div>
    ...
    <form action="{{ route('admin.settings.footer-links.store') }}" method="POST" x-data="footerLinkForm()">
        @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="column" id="column" required
                            ...
                            <option value="1" {{ old('column') == 1 ? 'selected' : '' }}>Column 1</option>
                            <option value="2" {{ old('column') == 2 ? 'selected' : '' }}>Column 2</option>
                            <option value="3" {{ old('column') == 3 ? 'selected' : '' }}>Column 3</option>
                            <option value="4" {{ old('column') == 4 ? 'selected' : '' }}>Column 4</option>
                        </select>
