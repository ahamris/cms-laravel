        ...
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-8 flex justify-center">
                <div class="w-24 h-24 rounded-full bg-red-100 dark:bg-red-900/20 flex items-center justify-center">
                    <i class="fa-solid fa-lock text-red-600 dark:text-red-400 text-5xl"></i>
                </div>
            </div>

            {{-- Error Code --}}
            <h1 class="text-9xl font-bold text-red-600 dark:text-red-400 mb-4">403</h1>

            {{-- Error Message --}}
            <h2 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 mb-3">Access Forbidden</h2>
