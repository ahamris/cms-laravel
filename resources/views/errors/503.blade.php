...
<head>
    ...
    <title>503 - Maintenance Mode - {{ config('app.name', 'Laravel') }}</title>
        ...
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-8 flex justify-center">
                <div class="w-24 h-24 rounded-full bg-[var(--color-accent)]/10 dark:bg-[var(--color-accent)]/20 flex items-center justify-center">
                    <i class="fa-solid fa-tools text-[var(--color-accent)] dark:text-[var(--color-accent-content)] text-5xl"></i>
                </div>
            </div>

            {{-- Error Code --}}
            <h1 class="text-9xl font-bold text-[var(--color-accent)] dark:text-[var(--color-accent-content)] mb-4">503</h1>

            {{-- Error Message --}}
            <h2 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 mb-3">Maintenance Mode</h2>
