    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-8 flex justify-center">
                <div class="w-24 h-24 rounded-full bg-[var(--color-accent)]/10 dark:bg-[var(--color-accent)]/20 flex items-center justify-center">
                    <i class="fa-solid fa-exclamation-triangle text-[var(--color-accent)] dark:text-[var(--color-accent-content)] text-5xl"></i>
                </div>
            </div>

            {{-- Error Code --}}
            <h1 class="text-9xl font-bold text-[var(--color-accent)] dark:text-[var(--color-accent-content)] mb-4">404</h1>

            {{-- Error Message --}}
            <h2 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 mb-3">Page Not Found</h2>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ url()->previous() }}" class="inline-flex items-center justify-center px-6 py-3 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors">
