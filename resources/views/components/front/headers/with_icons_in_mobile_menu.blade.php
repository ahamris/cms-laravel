                                        ...
                                        @if(!empty($menuItem['children']))
                                            <div class="-mx-3">
                                                @foreach($menuItem['children'] as $child)
                                                    <a href="{{ $child['url'] ?? '#' }}"
                                                        class="group flex items-center gap-x-6 rounded-lg p-3 text-base/7 font-semibold text-gray-900 hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">
                                                        <div
                                                            class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white dark:bg-gray-800 dark:group-hover:bg-gray-700">
                                                            @if(!empty($child['icon']))
                                                                <i
                                                                    class="{{ $child['icon'] }} text-gray-600 group-hover:text-indigo-600 dark:text-gray-300 dark:group-hover:text-white text-xl"></i>
                                                            @else
