  ...
  <div class="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
        ...
        @php
            $companyMission = get_setting('site_description', 'Making the world a better place through constructing elegant hierarchies.');
        @endphp
        <p class="text-sm/6 text-balance text-gray-600 dark:text-gray-400">{{ $companyMission }}</p>
