...
@if($hasCustomSlots)
    ...
    <div class="relative inline-block" x-data="{ open: false }" x-cloak @click.outside="open = false">
        <div x-ref="trigger" @click="open = !open" class="inline-block cursor-pointer">
            {{ $trigger }}
        </div>
        <div
                x-show="open"
                ...
                class="z-50 w-64 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg shadow-lg overflow-hidden"
                style="display: none;"
        >
            {{ $content }}
        </div>
    ...
    removeValue(value) {
        ...
        <div class="relative {{ $label ? 'mt-2' : '' }}" @click.outside="open = false">
            ...
            <div
                    ...
                    class="z-[9999] w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg max-h-60 overflow-y-auto"
                    style="display: none;"
            >
                @if($multiple)
