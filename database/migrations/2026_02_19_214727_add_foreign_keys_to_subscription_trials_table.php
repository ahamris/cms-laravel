...
return new class extends Migration
{
    ...
    {
        Schema::table('subscription_trials', function (Blueprint $table) {
    ...
    {
        Schema::table('subscription_trials', function (Blueprint $table) {
            $table->dropForeign('subscription_trials_subscription_id_foreign');
            $table->dropForeign('subscription_trials_user_id_foreign');
        });
    }
};
