...
class LoginSettingController extends AdminBaseController
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'login_page_logo' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
    ...
    private function getDescription(string $key): ?string
    {
        $descriptions = [
            ...
            'login_page_logo' => 'The logo displayed on the login page (JPEG, PNG, JPG, GIF, SVG - Max: 2MB)',
            'login_background_image' => 'The background image for the login page (JPEG, PNG, JPG - Max: 5MB)',
