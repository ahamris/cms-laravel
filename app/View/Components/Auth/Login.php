...
class Login extends Component
{
    ...
    public bool $enableForgotPassword;
    public array $footerLinks;

    public function __construct()
    {
        $this->mode = Setting::getValue('theme_login_form_mode', 'white');
        $this->pageTitle = Setting::getValue('login_page_title', 'Log in');
        $this->pageSubtitle = Setting::getValue('login_page_subtitle', 'Enter your credentials to access your account');
        ...
        $this->enableRememberMe = Setting::getValue('login_enable_remember_me', '1') === '1';
        $this->enableForgotPassword = Setting::getValue('login_enable_forgot_password', '1') === '1';
