...
class Radio extends Component
{
    ...
    public function __construct(
        ...
        $this->radioId = $id ?? ($name && $value ? $name.'-'.$value : 'radio-'.uniqid());

        $inputClasses = ['w-4 h-4 rounded-full border-gray-400 dark:border-gray-600 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-0'];
