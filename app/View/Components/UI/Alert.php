...
class Alert extends Component
{
    ...
    public function __construct(
        ...
        $classes = ['flex items-start gap-3 px-4 py-2 my-4 rounded-lg border transition-all duration-200'];
