...
//        ['Webmaster', 'Account', 'selim@code-labs.nl', '@14396Oem!!', self::ROLE_ADMIN],
    ...
    public static array $fullPermissions = [
        ...
        'academy_category_access' => [self::ROLE_ADMIN],
        'academy_category_show' => [self::ROLE_ADMIN],
        'academy_category_create' => [self::ROLE_ADMIN],
        'academy_category_edit' => [self::ROLE_ADMIN],
        'academy_category_delete' => [self::ROLE_ADMIN],

        'academy_chapter_access' => [self::ROLE_ADMIN],
        'academy_chapter_show' => [self::ROLE_ADMIN],
        'academy_chapter_create' => [self::ROLE_ADMIN],
        'academy_chapter_edit' => [self::ROLE_ADMIN],
        'academy_chapter_delete' => [self::ROLE_ADMIN],

        'academy_video_access' => [self::ROLE_ADMIN],
        'academy_video_show' => [self::ROLE_ADMIN],
        'academy_video_create' => [self::ROLE_ADMIN],
        'academy_video_edit' => [self::ROLE_ADMIN],
        'academy_video_delete' => [self::ROLE_ADMIN],
