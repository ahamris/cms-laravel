...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'layout', type: 'string', description: 'Page layout key (e.g. default, landing, minimal)', nullable: true),
        new OA\Property(property: 'template', type: 'string', description: 'Frontend template hint (e.g. contact, page)'),
